...
def getsize(l, h, t):
    if (l >= 3.5 or l <= 4.25) and (h >= 3.5 or h <= 6) and (t >= 0.007 or t <= 0.016): postclass == "Regular Post Card"                #If the length is between 
    ...
    #elif (l > 6.125 and h > 18  and t > 0.5):
    return postclass

def getzone():
    if (zip1 and zip2 >= 1 or zip1 and zip2 <= 6999): zonenumber = 1
    elif (zip1 and zip2 >= )
