...
4) Make a selection based on available data
''')
        time.sleep(1)
        ...
        if answer == "1":
            ...
            make_simple_selections(file_input)
        elif answer == ""
...
def count_seniors(file_input):
    ...
    print("The kids in 12th grade are: ")
...
def make_simple_selections(file_input):
    """
    This function allows the user to make simple selections based on 5 choices: Find 
    """
